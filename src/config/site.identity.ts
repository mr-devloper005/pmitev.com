export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'pmitev',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Pmitev',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'pmitev.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://pmitev.com',
